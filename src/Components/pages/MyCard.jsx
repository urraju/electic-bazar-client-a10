...
import Footer from '../Footer/Footer';
 ...
 const MyCard = () => {
    ...
    console.log(useData);
    return (
       <div className='h-sreen w-full mt-10 bg-black bg-gradient-to-t   from-violet-800'>
        <div>
            <h1 className='text-white text-center font-philospar text-4xl first-letter:text-5xl first-letter:text-sky-500 py-6'>You want to Add more product</h1>
        </div>
