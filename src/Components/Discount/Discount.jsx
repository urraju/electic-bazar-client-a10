  ...
  return (
    <div className="lg:w-9/12 mt-10 mx-auto mb-20 p-10">
      ...
      <div className="text-center mb-14">
        <h1 className="md:text-4xl text-3xl font-philospar font-bold">Black <span className="text-rose-500 ">Friday</span> Our <br />  Service</h1>
        <p className="mt-4 mx-auto">This service may be used either at noon or in the evening of Good Friday. It is preferable that there are</p>
      </div>
      <div className=" flex flex-col md:flex-row items-center  gap-10">
        ...
        <div className="font-philospar">
            ...
            <p className="md:w-[500px] text-sm">Looking for the perfect laptop,eyarphon,mouse,keyabord,monitor to enhance your productivity, gaming, or entertainment experience? Look no further! We're excited to offer you an exclusive limited-time discount on our top-rated laptops. Don't miss this opportunity to save big on cutting-edge technology.</p>
