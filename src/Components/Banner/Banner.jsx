...
const Banner = () => {
    return (
        <div className='bg-backgroudBanner absolute -z-30 top-0 bg-cover bg-no-repeat w-full h-[750px]'>
            <div className='h-full -z-30  w-full bg-black opacity-60'></div>
          ...
          <div className='font-philospar '>
                <h1 className='text-white first-letter:text-6xl first-letter:text-sky-500 font-semibold text-5xl'>You can intarest visit <br /> Our Laptop Bazar</h1>
